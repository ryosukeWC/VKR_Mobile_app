...
def register_client(user_data: schemas.UserCreate, db: Session = Depends(get_db)):
    user = models.User(
...
@app.get("/admin/restaurant-reservations/{restaurant_id}")
...
@app.put("/admin/confirm-reservation/{reservation_id}")
